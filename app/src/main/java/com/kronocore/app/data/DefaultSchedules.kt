...
object DefaultSchedules {
    ...
    fun getDefaultReminders(): List<Reminder> {
        ...
        // Instagram Schedule (IST, every day)
        val instagramTimes = listOf(
            Pair(1, 30),   // 1:30 AM IST
            Pair(3, 30),   // 3:30 AM IST
            Pair(7, 30),   // 7:30 AM IST
            Pair(19, 30),  // 7:30 PM IST
            Pair(21, 30),  // 9:30 PM IST
            Pair(23, 30)   // 11:30 PM IST
        )
